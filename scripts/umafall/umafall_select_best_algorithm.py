...
for c in classifiers:
    ...
    project.log("Classifier = {} | Accuracy = {} | Precision: {} | Recall: {} | F-Score: {} | Time: {}".format(type(classifiers[c]).__name__, st.mean(person_accuracies), st.mean(person_precision), st.mean(person_recall), st.mean(person_f_score),st.mean(times_to_predict)), file="new_results{}umafall_best_algorithm.log".format(slash))
