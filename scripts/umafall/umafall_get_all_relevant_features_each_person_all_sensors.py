...
for p in persons: 
    ...
    data = umafall.load_training_data_by_people(p, additional_where = "") #ALL SENSORS
    ...
    if len(classes_counts) > 1:
        ...
        s.save_var(relevant_features, "umafall_relevant_features_best_window_all_sensors{}relevant_features_{}.pkl".format(slash, p))
        s.save_var(y, "umafall_relevant_features_best_window_all_sensors{}y_{}.pkl".format(slash, p))
