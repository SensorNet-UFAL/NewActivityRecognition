...
project.log("====================UMAFALL BEST THRESHOLD============================", file="umafall_log_best_threshold.log")
for t in np.arange(0.05, 1, 0.05):
    ...
    for p in person_list:
        ...
        if isinstance(balanced_data, tuple):
            ...
            return_proba = base_classification.get_accuracy.simple_accuracy_mean_to_each_person_with_proba(data, umafall, extra_trees, t)
        ...
        #break   
    project.log("accuracy: {}, discarted_register: {}, discarted_activity: {}, threshold: {}".format(st.mean(accuracy_threshould_temp_aux["accuracy"]), st.mean(accuracy_threshould_temp_aux["discarted"]), st.mean(accuracy_threshould_temp_aux["discarted_activity"]), t), file="umafall_log_best_threshold.log")
    ...
    #break
project.log("================================================", file="umafall_log_best_threshold.log")