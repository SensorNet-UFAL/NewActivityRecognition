...
for c in classifiers:
    ...
    for p in persons:
        s = save()
        try:
            relevant_features = s.load_var("hmp_relevant_features_fix_window{}relevant_features_{}.pkl".format(slash, p))
            y = s.load_var("hmp_relevant_features_fix_window{}y_{}.pkl".format(slash, p))
